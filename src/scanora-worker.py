...
def lambda_handler(event, context):
    ...
    folder_name_resp = "resphtml"
    folder_name_json = "payloadjson"
    ...
    # --- Get Secret ---
    start = time.time()
    secret_value = secrets_client.get_secret_value(SecretId="scanora-br-api-key")
    br_secret = json.loads(secret_value['SecretString'])['scanora-br-api-key']
